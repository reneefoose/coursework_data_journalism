...
```
```{R}
#here is where I wrote a view function and the data crashed.
```
...
# Hint: you'll need to group by more than just the pharmacy name to answer this question correctly.  New Health Care Services

#Do some quick web research/reporting.  What actions did the DEA and state of Maryland take against this pharmacy? Why did they do it? They were charges with the illegal sale of millions of pills and they were ordered to forefit property.
...
#A federal judge in Maryland today unsealed a grand indictement that charged a Baltimore pharmacy with illegally selling millions of hydrocodone over the internet engaging in a criminal enterprise and filing false tax returns in an effort to conspire and defraud the IRS, the State of Maryland, and the City of Baltimore.
